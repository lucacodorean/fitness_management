...
public class Employee {
    ...
    public Employee(String email, String password) throws SQLException { 
        ...
        if(Arrays.equals(data, Variables.NULL_ARRAY)) {
        ...
        setEmployement(LocalDateTime.parse(data[6], DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
        setRole(Integer.parseInt(data[7]));
    }

    public void setWage(Integer wage)               { this.wage = wage; }
    ...
    public void setEmployement(LocalDateTime time)  { this.employementDate = time; }
    ...
    public LocalDateTime    getEmployment()         { return employementDate; }
